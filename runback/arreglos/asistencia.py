...
# # try:
# #
# coordinacion = Coordinacion.objects.get(pk=4)
...
# #materia = Materia.objects.filter(nivel__periodo_id=113).exclude(nivel__modalidad_id=3)
# #materia = Materia.objects.filter(pk=37361)
