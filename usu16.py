...
print(int(encrypt('OPPQQRRSSTTUUVVPVVXU')))


# codigos materia investigacion
...
silaboxduplicar = Silabo.objects.filter(materia_id=74689)[0]
listadoprofesormateria1 = ProfesorMateria.objects.filter(materia__nivel__periodo_id=224, tipoprofesor_id=16, materia__modeloevaluativo_id=27, status=True, materia_id=72474).exclude(materia_id__in=[74689])
...
#         print(cuenta)
c = 1
listadoprofesormateria = ProfesorMateria.objects.filter(materia__nivel__periodo_id=224, tipoprofesor_id=16,materia__modeloevaluativo_id=27,status=True, materia_id=72474).exclude(materia_id__in=[74689])
