(function () {
    ...
    var l, h, e, i, o, n, s, r, a, _, c, u, b, d, p, f, g, y, w, m, v, C, x, k, D, T, S, E, I, A, P, N, O, M, $, H, L,
        R, W, F, j, z, q, B, U, Y, K, V, X, Q = [].slice, G = {}.hasOwnProperty, J = [].indexOf || function (t) {
    ...
    for (v = {
        ...
        var t, e, i, n, s, o, r;
        for (e = arguments[0], o = 0, r = (n = 2 <= arguments.length ? Q.call(arguments, 1) : []).length; o < r; o++) if (i = n[o]) for (t in i) G.call(i, t) && (s = i[t], null != e[t] && "object" == typeof e[t] && null != s && "object" == typeof s ? C(e[t], s) : e[t] = s);
        return e
    }, g = function (t) {
        var e, i, n, s, o;
    ...
    X = Error, t(at, X), a = at, rt.prototype.getElement = function () {
        ...
        var e, i, n, s;
        for (i = 0, n = (s = A.ajax.ignoreURLs).length; i < n; i++) if ("string" == typeof (e = s[i])) {
    ...
    }, o = it, et.prototype.states = {loading: 0, interactive: 50, complete: 100}, e = et, n = function () {
    ...
    }), u = {ajax: l, elements: i, document: e, eventLag: n}, (E = function () {
        var t, e, i, n, s, o, r, a;
        ...
        return _.running = !0, y.render(), v = I(), w = !1, f = O(function (t, e) {
            ...
            for (y.progress, n = u = 0, s = !0, a = d = 0, f = R.length; d < f; a = ++d) for (L = R[a], c = null != M[a] ? M[a] : M[a] = [], l = p = 0, g = (r = null != (m = L.elements) ? m : [L]).length; p < g; l = ++p) o = r[l], s &= (h = null != c[l] ? c[l] : c[l] = new b(o)).done, h.done || (n++, u += h.tick(t));
    ...
    var e = [], k = x.document, n = Object.getPrototypeOf, a = e.slice, m = e.concat, l = e.push, s = e.indexOf, i = {},
        o = i.toString, v = i.hasOwnProperty, r = v.toString, h = r.call(Object), _ = {}, b = function (t) {
    ...
    D.fn = D.prototype = {
        jquery: "3.4.1", constructor: D, length: 0, toArray: function () {
            return a.call(this)
        }, get: function (t) {
        ...
        for ("boolean" == typeof r && (h = r, r = arguments[a] || {}, a++), "object" == typeof r || b(r) || (r = {}), a === l && (r = this, a--); a < l; a++) if (null != (t = arguments[a])) for (e in t) n = t[e], "__proto__" !== e && r !== n && (h && n && (D.isPlainObject(n) || (s = Array.isArray(n))) ? (i = r[e], o = s && !Array.isArray(i) ? [] : s || D.isPlainObject(i) ? i : {}, s = !1, r[e] = D.extend(h, o, n)) : void 0 !== n && (r[e] = n));
        return r
    }, D.extend({
    ...
    var p = function (i) {
        ...
        var t, p, y, o, r, f, d, g, w, l, h, C, x, a, k, m, c, v, _, D = "sizzle" + +new Date, b = i.document, T = 0,
            n = 0, S = lt(), E = lt(), I = lt(), A = lt(), P = function (t, e) {
                return t === e && (h = !0), 0
            }, N = {}.hasOwnProperty, e = [], O = e.pop, M = e.push, $ = e.push, H = e.slice, L = function (t, e) {
            ...
            j = "\\[" + W + "*(" + F + ")(?:" + W + "*([*^$|!~]?=)" + W + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + F + "))|)" + W + "*\\]",
            z = ":(" + F + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + j + ")*)|.*)\\)|)",
            q = new RegExp(W + "+", "g"), B = new RegExp("^" + W + "+|((?:^|[^\\\\])(?:\\\\.)*)" + W + "+$", "g"),
            U = new RegExp("^" + W + "*," + W + "*"), Y = new RegExp("^" + W + "*([>+~]|" + W + ")" + W + "*"),
            K = new RegExp(W + "|>"), V = new RegExp(z), X = new RegExp("^" + F + "$"), Q = {
                ID: new RegExp("^#(" + F + ")"),
                CLASS: new RegExp("^\\.(" + F + ")"),
                TAG: new RegExp("^(" + F + "|[*])"),
                ATTR: new RegExp("^" + j),
            ...
            }, G = /HTML$/i, J = /^(?:input|select|textarea|button)$/i, Z = /^h\d$/i, tt = /^[^{]+\{\s*\[native \w/,
            et = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, it = /[+~]/,
            nt = new RegExp("\\\\([\\da-f]{1,6}" + W + "?|(" + W + ")|.)", "ig"),
            st = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, ot = function (t, e) {
        ...
        for (t in p = at.support = {}, r = at.isXML = function (t) {
            ...
            filter: {
                TAG: function (t) {
                    ...
                    var v = "nth" !== f.slice(0, 3), _ = "last" !== f.slice(-4), b = "of-type" === t;
                    return 1 === g && 0 === m ? function (t) {
                        return !!t.parentNode
                    } : function (t, e, i) {
                        var n, s, o, r, a, l, h = v != _ ? "nextSibling" : "previousSibling", c = t.parentNode,
                            u = b && t.nodeName.toLowerCase(), d = !i && !b, p = !1;
                        if (c) {
                            if (v) {
                                for (; h;) {
                            ...
                            if (l = [_ ? c.firstChild : c.lastChild], _ && d) {
                                for (p = (a = (n = (s = (o = (r = c)[D] || (r[D] = {}))[r.uniqueID] || (o[r.uniqueID] = {}))[f] || [])[0] === T && n[1]) && n[2], r = a && c.childNodes[a]; r = ++a && r && r[h] || (p = a = 0) || l.pop();) if (1 === r.nodeType && ++p && r === t) {
                                    s[f] = [T, a, p];
                                    break
                                }
                            } else if (d && (p = a = (n = (s = (o = (r = t)[D] || (r[D] = {}))[r.uniqueID] || (o[r.uniqueID] = {}))[f] || [])[0] === T && n[1]), !1 === p) for (; (r = ++a && r && r[h] || (p = a = 0) || l.pop()) && ((b ? r.nodeName.toLowerCase() !== u : 1 !== r.nodeType) || !++p || (d && ((s = (o = r[D] || (r[D] = {}))[r.uniqueID] || (o[r.uniqueID] = {}))[f] = [T, p]), r !== t));) ;
            ...
            pseudos: {
                not: ht(function (t) {
                    ...
                    return e = e.replace(nt, u), function (t) {
                        return -1 < (t.textContent || o(t)).indexOf(e)
                    }
                }), lang: ht(function (i) {
                    return X.test(i || "") || at.error("unsupported lang: " + i), i = i.replace(nt, u).toLowerCase(), function (t) {
                        var e;
                        do {
        ...
        function yt(a, t, e) {
            var l = t.dir, h = t.next, c = h || l, u = e && "parentNode" === c, d = n++;
            return t.first ? function (t, e, i) {
                ...
                } else for (; t = t[l];) if (1 === t.nodeType || u) if (s = (o = t[D] || (t[D] = {}))[t.uniqueID] || (o[t.uniqueID] = {}), h && h === t.nodeName.toLowerCase()) t = t[l] || t; else {
        ...
        function xt(p, f, g, m, v, t) {
            return m && !m[D] && (m = xt(m)), v && !v[D] && (v = xt(v, t)), ht(function (t, e, i, n) {
                var s, o, r, a = [], l = [], h = e.length, c = t || function (t, e, i) {
                        for (var n = 0, s = e.length; n < s; n++) at(t, e[n], i);
                        return i
                    }(f || "*", i.nodeType ? [i] : i, []), u = !p || !t && f ? c : Ct(c, a, p, i, n),
                    d = g ? v || (t ? p : h || m) ? [] : e : u;
        ...
        function kt(t) {
            for (var s, e, i, n = t.length, o = y.relative[t[0].type], r = o || y.relative[" "], a = o ? 1 : 0, l = yt(function (t) {
                ...
                return s = null, n
            }]; a < n; a++) if (e = y.relative[t[a].type]) c = [yt(wt(c), e)]; else {
        ...
        return _t.prototype = y.filters = y.pseudos, y.setFilters = new _t, f = at.tokenize = function (t, e) {
            ...
            var s, o, r, a, l, h = "function" == typeof t && t, c = !n && f(t = h.selector || t);
            if (i = i || [], 1 === c.length) {
                ...
                for (s = Q.needsContext.test(t) ? 0 : o.length; s-- && (r = o[s], !y.relative[a = r.type]);) if ((l = y.find[a]) && (n = l(r.matches[0].replace(nt, u), it.test(o[0].type) && vt(e.parentNode) || e))) {
    ...
    (D.fn.init = function (t, e, i) {
        ...
        if (n[1]) {
            if (e = e instanceof D ? e[0] : e, D.merge(this, D.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : k, !0)), E.test(n[1]) && D.isPlainObject(e)) for (n in e) b(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
            return this
        }
    ...
    D.fn.extend({
        has: function (t) {
            var e = D(t, this), i = e.length;
            return this.filter(function () {
                for (var t = 0; t < i; t++) if (D.contains(this, e[t])) return !0
            })
        }, closest: function (t, e) {
            var i, n = 0, s = this.length, o = [], r = "string" != typeof t && D(t);
            if (!T.test(t)) for (; n < s; n++) for (i = this[n]; i && i !== e; i = i.parentNode) if (i.nodeType < 11 && (r ? -1 < r.index(i) : 1 === i.nodeType && D.find.matchesSelector(i, t))) {
                o.push(i);
                break
            }
    ...
    D.Callbacks = function (n) {
        ...
        function s() {
            for (r = r || n.once, e = o = !0; l.length; h = -1) for (t = l.shift(); ++h < a.length;) !1 === a[h].apply(t[0], t[1]) && n.stopOnFalse && (h = a.length, t = !1);
            n.memory || (t = !1), o = !1, r && (a = t ? [] : "")
        }

        var o, t, e, r, a = [], l = [], h = -1, c = {
            add: function () {
        ...
        Deferred: function (t) {
            ...
            var i = arguments.length, n = i, s = Array(n), o = a.call(arguments), r = D.Deferred();
    ...
    var z = function (t, e, i, n, s, o, r) {
        ...
        if ("object" === w(i)) for (a in s = !0, i) z(t, e, a, i[a], !0, o, r); else if (void 0 !== n && (s = !0, b(n) || (r = !0), h && (e = r ? (e.call(t, n), null) : (h = e, function (t, e, i) {
            return h.call(D(t), i)
    ...
    var X = new V, Q = new V, G = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, J = /[A-Z]/g;

    function Z(t, e, i) {
        var n, s;
        if (void 0 === i && 1 === t.nodeType) if (n = "data-" + e.replace(J, "-$&").toLowerCase(), "string" == typeof (i = t.getAttribute(n))) {
            try {
    ...
    D.extend({
        ...
        queue: function (t, e, i) {
            ...
            e = e || "fx";
            var i = D.queue(t, e), n = i.length, s = i.shift(), o = D._queueHooks(t, e);
        ...
        queue: function (e, i) {
            ...
            var n, s = 1, o = D.Deferred(), r = this, a = this.length;
    ...
    var tt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, et = new RegExp("^(?:([+-])=|)(" + tt + ")([a-z%]*)$", "i"),
        it = ["Top", "Right", "Bottom", "Left"], nt = k.documentElement, st = function (t) {
    ...
    function yt(t, e, i, n, s) {
        for (var o, r, a, l, h, c, u = e.createDocumentFragment(), d = [], p = 0, f = t.length; p < f; p++) if ((o = t[p]) || 0 === o) if ("object" === w(o)) D.merge(d, o.nodeType ? [o] : o); else if (bt.test(o)) {
        ...
        for (u.textContent = "", p = 0; o = d[p++];) if (n && -1 < D.inArray(o, n)) s && s.push(o); else if (h = st(o), r = gt(u.appendChild(o), "script"), h && mt(r), i) for (c = 0; o = r[c++];) pt.test(o.type || "") && i.push(o);
        return u
    }
    ...
    var wt = /^key/, Ct = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, xt = /^([^.]*)(?:\.(.+)|)/;
        ...
        o ? (X.set(t, s, !1), D.event.add(t, s, {
            namespace: !1, handler: function (t) {
                ...
                if (1 & t.isTrigger && this[s]) {
                    if (n.length) (D.event.special[s] || {}).delegateType && t.stopPropagation(); else if (n = a.call(arguments), X.set(this, s, n), e = o(this, s), this[s](), n !== (i = X.get(this, s)) || e ? X.set(this, s, !1) : i = {}, n !== i) return t.stopImmediatePropagation(), t.preventDefault(), i.value
    ...
    D.event = {
        global: {}, add: function (e, t, i, n, s) {
            ...
            if (m) for (i.handler && (i = (o = i).handler, s = o.selector), s && D.find.matchesSelector(nt, s), i.guid || (i.guid = D.guid++), (l = m.events) || (l = m.events = {}), (r = m.handle) || (r = m.handle = function (t) {
            ...
            if (m && (l = m.events)) {
                for (h = (e = (e || "").match($) || [""]).length; h--;) if (p = g = (a = xt.exec(e[h]) || [])[1], f = (a[2] || "").split(".").sort(), p) {
            ...
            var e, i, n, s, o, r, a = D.event.fix(t), l = new Array(arguments.length),
                h = (X.get(this, "events") || {})[a.type] || [], c = D.event.special[a.type] || {};
    ...
    }, D.event.addProp), D.each({focus: "focusin", blur: "focusout"}, function (t, e) {
        D.event.special[t] = {
            setup: function () {
    ...
    var It = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,
        At = /<script|<style|<link/i, Pt = /checked\s*(?:[^=]|=\s*.checked.)/i,
        Nt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    ...
    function Ht(t, e) {
        var i, n, s, o, r, a, l, h;
        if (1 === e.nodeType) {
            if (X.hasData(t) && (o = X.access(t), r = X.set(e, o), h = o.events)) for (s in delete r.handle, r.events = {}, h) for (i = 0, n = h[s].length; i < n; i++) D.event.add(e, s, h[s][i]);
    ...
    function Lt(i, n, s, o) {
        n = m.apply([], n);
        var t, e, r, a, l, h, c = 0, u = i.length, d = u - 1, p = n[0], f = b(p);
        ...
        if (u && (e = (t = yt(n, i[0].ownerDocument, !1, i, o)).firstChild, 1 === t.childNodes.length && (t = e), e || o)) {
            ...
            if (a) for (h = r[r.length - 1].ownerDocument, D.map(r, $t), c = 0; c < a; c++) l = r[c], pt.test(l.type || "") && !X.access(l, "globalEval") && D.contains(h, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? D._evalUrl && !l.noModule && D._evalUrl(l.src, {nonce: l.nonce || l.getAttribute("nonce")}) : y(l.textContent.replace(Nt, ""), l, h))
        }
        return i
    }
    ...
    D.extend({
        htmlPrefilter: function (t) {
            ...
            if (!(_.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || D.isXMLDoc(t))) for (r = gt(c), n = 0, s = (o = gt(t)).length; n < s; n++) a = o[n], "input" === (h = (l = r[n]).nodeName.toLowerCase()) && ut.test(a.type) ? l.checked = a.checked : "input" !== h && "textarea" !== h || (l.defaultValue = a.defaultValue);
            if (e) if (i) for (o = o || gt(t), r = r || gt(c), n = 0, s = o.length; n < s; n++) Ht(o[n], r[n]); else Ht(t, c);
            return 0 < (r = gt(c, "script")).length && mt(r, !u && gt(t, "script")), c
        }, cleanData: function (t) {
            for (var e, i, n, s = D.event.special, o = 0; void 0 !== (i = t[o]); o++) if (K(i)) {
                if (e = i[X.expando]) {
                    if (e.events) for (n in e.events) s[n] ? D.event.remove(i, n) : D.removeEvent(i, n, e.handle);
                    i[X.expando] = void 0
                }
    ...
    var Wt, Ft, jt, zt, qt, Bt, Ut, Yt = new RegExp("^(" + tt + ")(?!px)[a-z%]+$", "i"), Kt = function (t) {
    ...
    var Zt = ["Webkit", "Moz", "ms"], te = k.createElement("div").style, ee = {};
    ...
    function he(t, e, i) {
        var n = Kt(t), s = (!_.boxSizingReliable() || i) && "border-box" === D.css(t, "boxSizing", !1, n), o = s,
            r = Xt(t, e, n), a = "offset" + e[0].toUpperCase() + e.slice(1);
        if (Yt.test(r)) {
            if (!i) return r;
            r = "auto"
        }
    ...
    D.extend({
        ...
        style: function (t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var s, o, r, a = Y(e), l = se.test(e), h = t.style;
        ...
        D.cssHooks[l] = {
            get: function (t, e, i) {
                ...
                var n, s = Kt(t), o = !_.scrollboxSize() && "absolute" === s.position,
                    r = (o || i) && "border-box" === D.css(t, "boxSizing", !1, s), a = i ? le(t, l, i, r, s) : 0;
        ...
        constructor: ce, init: function (t, e, i, n, s, o) {
    ...
    var ue, de, pe, fe, ge = /^(?:toggle|show|hide)$/, me = /queueHooks$/;
    ...
    function we(o, t, e) {
        var i, r, n = 0, s = we.prefilters.length, a = D.Deferred().always(function () {
            delete l.elem
        }), l = function () {
            if (r) return !1;
        ...
        for (function (t, e) {
            var i, n, s, o, r;
            for (i in t) if (s = e[n = Y(i)], o = t[i], Array.isArray(o) && (s = o[1], o = t[i] = o[0]), i !== n && (t[n] = o, delete t[i]), (r = D.cssHooks[n]) && "expand" in r) for (i in o = r.expand(o), delete t[n], o) i in t || (t[i] = o[i], e[i] = s); else e[n] = s
        }(c, h.opts.specialEasing); n < s; n++) if (i = we.prefilters[n].call(h, o, c, h.opts)) return b(i.stop) && (D._queueHooks(h.elem, h.opts.queue).stop = i.stop.bind(i)), i;
    ...
    D.Animation = D.extend(we, {
        tweeners: {
            ...
            var n, s, o, r, a, l, h, c, u = "width" in e || "height" in e, d = this, p = {}, f = t.style,
                g = t.nodeType && rt(t), m = X.get(t, "fxshow");
            ...
            if ((l = !D.isEmptyObject(e)) || !D.isEmptyObject(p)) for (n in u && 1 === t.nodeType && (i.overflow = [f.overflow, f.overflowX, f.overflowY], null == (h = m && m.display) && (h = X.get(t, "display")), "none" === (c = D.css(t, "display")) && (h ? c = h : (ct([t], !0), h = t.style.display || h, c = D.css(t, "display"), ct([t]))), ("inline" === c || "inline-block" === c && null != h) && "none" === D.css(t, "float") && (l || (d.done(function () {
                f.display = h
            }), null == h && (c = f.display, h = "none" === c ? "" : c)), f.display = "inline-block")), i.overflow && (f.overflow = "hidden", d.always(function () {
                f.overflow = i.overflow[0], f.overflowX = i.overflow[1], f.overflowY = i.overflow[2]
            })), l = !1, p) l || (m ? "hidden" in m && (g = m.hidden) : m = X.access(t, "fxshow", {display: h}), o && (m.hidden = !g), g && ct([t], !0), d.done(function () {
        ...
        fadeTo: function (t, e, i, n) {
            ...
            var o = D.isEmptyObject(e), r = D.speed(t, i, n);
            ...
            return "string" != typeof s && (o = t, t = s, s = void 0), t && !1 !== s && this.queue(s || "fx", []), this.each(function () {
                var t = !0, e = null != s && s + "queueHooks", i = D.timers, n = X.get(this);
                if (e) n[e] && n[e].stop && r(n[e]); else for (e in n) n[e] && n[e].stop && me.test(e) && r(n[e]);
                for (e = i.length; e--;) i[e].elem !== this || null != s && i[e].queue !== s || (i[e].anim.stop(o), t = !1, i.splice(e, 1));
                !t && o || D.dequeue(this, s)
            })
        }, finish: function (r) {
            return !1 !== r && (r = r || "fx"), this.each(function () {
                var t, e = X.get(this), i = e[r + "queue"], n = e[r + "queueHooks"], s = D.timers, o = i ? i.length : 0;
        ...
        de = null
    }, D.fx.speeds = {slow: 600, fast: 200, _default: 400}, D.fn.delay = function (n, t) {
    ...
    var ke = /^(?:input|select|textarea|button)$/i, De = /^(?:a|area)$/i;
    ...
    D.fn.extend({
        ...
        addClass: function (e) {
            ...
            if ((t = Ee(e)).length) for (; i = this[l++];) if (s = Se(i), n = 1 === i.nodeType && " " + Te(s) + " ") {
            ...
            return "boolean" == typeof e && r ? e ? this.addClass(s) : this.removeClass(s) : b(s) ? this.each(function (t) {
                ...
                var t, e, i, n;
                if (r) for (e = 0, i = D(this), n = Ee(s); t = n[e++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else void 0 !== s && "boolean" != o || ((t = Se(this)) && X.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === s ? "" : X.get(this, "__className__") || ""))
            })
        }, hasClass: function (t) {
            var e, i, n = 0;
            for (e = " " + t + " "; i = this[n++];) if (1 === i.nodeType && -1 < (" " + Te(Se(i)) + " ").indexOf(e)) return !0;
            return !1
        }
    });
    var Ie = /\r/g;
            ...
            option: {
                ...
                get: function (t) {
                    var e, i, n, s = t.options, o = t.selectedIndex, r = "select-one" === t.type, a = r ? null : [],
                        l = r ? o + 1 : s.length;
                    for (n = o < 0 ? l : r ? o : 0; n < l; n++) if (((i = s[n]).selected || n === o) && !i.disabled && (!i.parentNode.disabled || !S(i.parentNode, "optgroup"))) {
    ...
    D.extend(D.event, {
        trigger: function (t, e, i, n) {
            var s, o, r, a, l, h, c, u, d = [i || k], p = v.call(t, "type") ? t.type : t,
            ...
            if (o = u = r = i = i || k, 3 !== i.nodeType && 8 !== i.nodeType && !Pe.test(p + D.event.triggered) && (-1 < p.indexOf(".") && (p = (f = p.split(".")).shift(), f.sort()), l = p.indexOf(":") < 0 && "on" + p, (t = t[D.expando] ? t : new D.Event(p, "object" == typeof t && t)).isTrigger = n ? 2 : 3, t.namespace = f.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), e = null == e ? [t] : D.makeArray(e, [t]), c = D.event.special[p] || {}, n || !c.trigger || !1 !== c.trigger.apply(i, e))) {
                ...
                for (s = 0; (o = d[s++]) && !t.isPropagationStopped();) u = o, t.type = 1 < s ? a : c.bindType || p, (h = (X.get(o, "events") || {})[t.type] && X.get(o, "handle")) && h.apply(o, e), (h = l && o[l]) && h.apply && K(o) && (t.result = h.apply(o, e), !1 === t.result && t.preventDefault());
    ...
    }), _.focusin || D.each({focus: "focusin", blur: "focusout"}, function (i, n) {
        function s(t) {
        ...
        D.event.special[n] = {
            setup: function () {
                var t = this.ownerDocument || this, e = X.access(t, n);
                e || t.addEventListener(i, s, !0), X.access(t, n, (e || 0) + 1)
            }, teardown: function () {
                var t = this.ownerDocument || this, e = X.access(t, n) - 1;
                e ? X.access(t, n, e) : (t.removeEventListener(i, s, !0), X.remove(t, n))
            }
        }
    });
    var Ne = x.location, Oe = Date.now(), Me = /\?/;
    ...
    function We(i, t, n, s) {
        ...
        }); else if (n || "object" !== w(t)) s(i, t); else for (e in t) We(i + "[" + e + "]", t[e], n, s)
    }
    ...
    var Fe = /%20/g, je = /#.*$/, ze = /([?&])_=[^&]*/, qe = /^(.*?):[ \t]*([^\r\n]*)$/gm, Be = /^(?:GET|HEAD)$/,
        Ue = /^\/\//, Ye = {}, Ke = {}, Ve = "*/".concat("*"), Xe = k.createElement("a");

    function Qe(o) {
        return function (t, e) {
            "string" != typeof t && (e = t, t = "*");
            var i, n = 0, s = t.toLowerCase().match($) || [];
    ...
    Xe.href = Ne.href, D.extend({
        ...
        ajax: function (t, e) {
            ...
            var c, u, d, i, p, n, f, g, s, o, m = D.ajaxSetup({}, e), v = m.context || m,
                _ = m.context && (v.nodeType || v.jquery) ? D(v) : D.event, b = D.Deferred(),
                y = D.Callbacks("once memory"), w = m.statusCode || {}, r = {}, a = {}, l = "canceled", C = {
                    readyState: 0, getResponseHeader: function (t) {
                        ...
                        var e;
                        if (t) if (f) C.always(t[C.status]); else for (e in t) w[e] = [w[e], t[e]];
                        return this
                    }, abort: function (t) {
                        var e = t || l;
    ...
    var Ze = {0: 200, 1223: 204}, ti = D.ajaxSettings.xhr();
    ...
    D.ajaxSetup({
        ...
        setOffset: function (t, e, i) {
            var n, s, o, r, a, l, h = D.css(t, "position"), c = D(t), u = {};
        ...
        offset: function (e) {
            ...
            if (this[0]) {
                ...
                if ("fixed" === D.css(n, "position")) e = n.getBoundingClientRect(); else {
    ...
    var n, s, C, k, r, a, l, h, c, D, d, p = 0, f = Array.prototype.slice;
    ...
    x.cleanData = (d = x.cleanData, function (t) {
        ...
        for (var e, i, n = f.call(arguments, 1), s = 0, o = n.length; s < o; s++) for (e in n[s]) i = n[s][e], n[s].hasOwnProperty(e) && void 0 !== i && (t[e] = x.isPlainObject(i) ? x.isPlainObject(t[e]) ? x.widget.extend({}, t[e], i) : x.widget.extend({}, i) : i);
        return t
    }, x.widget.bridge = function (o, e) {
        var r = e.prototype.widgetFullName || o;
        x.fn[o] = function (i) {
            var t = "string" == typeof i, n = f.call(arguments, 1), s = this;
        ...
        x.Widget.prototype["_" + o] = function (e, t, i) {
            ...
            "number" == typeof (t = t || {}) && (t = {duration: t}), n = !x.isEmptyObject(t), t.complete = i, t.delay && e.delay(t.delay), n && x.effects && x.effects.effect[s] ? e[o](t) : s !== o && e[s] ? e[s](t.duration, t.easing, i) : e.queue(function (t) {
        ...
        u = x.extend({}, u);
        var d, p, f, g, m, t, e, i, v = x(u.of), _ = x.position.getWithinInfo(u.within),
            b = x.position.getScrollInfo(_), y = (u.collision || "flip").split(" "), w = {};
        return t = 9 === (i = (e = v)[0]).nodeType ? {
            ...
            var i, t, r = x(this), a = r.outerWidth(), l = r.outerHeight(), e = S(this, "marginLeft"),
                n = S(this, "marginTop"), s = a + e + S(this, "marginRight") + b.width,
                o = l + n + S(this, "marginBottom") + b.height, h = x.extend({}, m),
        ...
        fit: {
            ...
            left: function (t, e) {
                var i, n, s = e.within, o = s.offset.left + s.scrollLeft, r = s.width,
                    ...
                    h = l - a, c = l + e.collisionWidth - r - a,
                ...
                var i, n, s = e.within, o = s.offset.top + s.scrollTop, r = s.height,
                    a = s.isWindow ? s.scrollTop : s.offset.top, l = t.top - e.collisionPosition.marginTop, h = l - a,
    ...
    var g, m, v, _, b, y, w, E, I, A, P, N, O, M, $, H, L, R, W, F, j, z = "ui-effects-", q = "ui-effects-style",
        B = "ui-effects-animated", U = x;

    function Y(t, e, i, n) {
        return x.isPlainObject(t) && (t = (e = t).effect), t = {effect: t}, null == e && (e = {}), x.isFunction(e) && (n = e, i = null, e = {}), "number" != typeof e && !x.fx.speeds[e] || (n = i, i = e, e = {}), x.isFunction(i) && (n = i, i = null), e && x.extend(t, e), i = i || e.duration, t.duration = x.fx.off ? 0 : "number" == typeof i ? i : i in x.fx.speeds ? x.fx.speeds[i] : x.fx.speeds._default, t.complete = n || e.complete, t
    }
    ...
    function X(t) {
        var e, i,
            ...
            s = {};
        if (n && n.length && n[0] && n[n[0]]) for (i = n.length; i--;) "string" == typeof n[e = n[i]] && (s[x.camelCase(e)] = n[e]); else for (e in n) "string" == typeof n[e] && (s[e] = n[e]);
        return s
    }
    ...
    x.effects = {effect: {}}, M = /^([\-+])=\s*(\d+\.?\d*)/, $ = [{
        ...
        var e, i, n = t[0] / 255, s = t[1] / 255, o = t[2] / 255, r = t[3], a = Math.max(n, s, o),
            l = Math.min(n, s, o), h = a - l, c = a + l, u = .5 * c;
        ...
        H.fn[l] = function (t) {
            ...
            var e, n = P.type(t), s = "array" === n || "object" === n ? t : arguments, o = this[r].slice();
            ...
            H.fn[r] || (H.fn[r] = function (t) {
                var e, i = P.type(t), n = "alpha" === r ? this._hsla ? "hsla" : "rgba" : l, s = this[n](), o = s[a.idx];
        ...
        return this.queue(function () {
            var t, i = x(this), e = i.attr("class") || "", n = o.children ? i.find("*").addBack() : i;
            n = n.map(function () {
        ...
        version: "1.12.1", define: function (t, e, i) {
            ...
            var e = z + "placeholder", i = t.data(e);
        ...
        effect: function () {
            ...
            var n = Y.apply(this, arguments), s = x.effects.effect[n.effect], o = s.mode, i = n.queue, r = i || "fx",
                a = n.complete, l = n.mode, h = [];
            ...
            var i = x(this), n = x(t.to), s = "fixed" === n.css("position"), o = x("body"), r = s ? o.scrollTop() : 0,
                a = s ? o.scrollLeft() : 0, l = n.offset(),
                h = {top: l.top - r, left: l.left - a, height: n.innerHeight(), width: n.innerWidth()}, c = i.offset(),
    ...
    x.effects.define("blind", "hide", function (t, e) {
        ...
        var i, n, s, o = x(this), r = t.mode, a = "hide" === r, l = "show" === r, h = t.direction || "up",
            c = t.distance, u = t.times || 5, d = 2 * u + (l || a ? 1 : 0), p = t.duration / d, f = t.easing,
        ...
        var i, n = {}, s = x(this), o = t.direction || "vertical", r = "both" === o, a = r || "horizontal" === o,
            l = r || "vertical" === o;
        i = s.cssClip(), n.clip = {
        ...
        var i, n = x(this), s = "show" === t.mode, o = t.direction || "left",
        ...
        var n, s, o, r, a, l, h = t.pieces ? Math.round(Math.sqrt(t.pieces)) : 3, c = h, u = x(this),
            d = "show" === t.mode, p = u.show().css("visibility", "hidden").offset(), f = Math.ceil(u.outerWidth() / c),
            g = Math.ceil(u.outerHeight() / h), m = [];
        for (n = 0; n < h; n++) for (r = p.top + n * g, l = n - (h - 1) / 2, s = 0; s < c; s++) o = p.left + s * f, a = s - (c - 1) / 2, u.clone().appendTo("body").wrap("<div></div>").css({
            position: "absolute",
            visibility: "visible",
            left: -s * f,
            top: -n * g
        ...
        var t, o, i, n = x(this), r = ["fontSize"],
            a = ["borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"],
            l = ["borderLeftWidth", "borderRightWidth", "paddingLeft", "paddingRight"], h = s.mode, c = "effect" !== h,
            u = s.scale || "both", d = s.origin || ["middle", "center"], p = n.css("position"), f = n.position(),
            g = x.effects.scaledDimensions(n), m = s.from || g, v = s.to || x.effects.scaledDimensions(n, 0);
        ...
        var i = x(this), n = t.mode, s = "show" === n, o = s || "hide" === n, r = 2 * (t.times || 5) + (o ? 1 : 0),
            a = t.duration / r, l = 0, h = 1, c = i.queue().length;
        ...
        var i = 1, n = x(this), s = t.direction || "left", o = t.distance || 20, r = t.times || 3, a = 2 * r + 1,
            ...
            c = "up" === s || "left" === s, u = {}, d = {}, p = {}, f = n.queue().length;
        ...
        var i, n, s = x(this),
            ...
            h = "up" === a || "left" === a, c = t.distance || s["top" == l ? "outerHeight" : "outerWidth"](!0), u = {};
        ...
        _eventHandler: function (t) {
            var e, i, n = this.options, s = this.active, o = x(t.currentTarget), r = o[0] === s[0],
                a = r && n.collapsible, l = a ? x() : o.next(), h = s.next(),
        ...
        _animate: function (t, i, e) {
            ...
            var s, o, r, a = this, l = 0, h = t.css("box-sizing"), c = t.length && (!i.length || t.index() < i.index()),
            ...
            return "number" == typeof d && (r = d), "string" == typeof d && (o = d), o = o || d.easing || u.easing, r = r || d.duration || u.duration, i.length ? t.length ? (s = t.show().outerHeight(), i.animate(this.hideProps, {
                ...
                duration: r, easing: o, complete: n, step: function (t, e) {
            ...
            this.activeMenu = this.element, this.mouseHandled = !1, this.element.uniqueId().attr({
                ...
                "mousedown .ui-menu-item": function (t) {
                    ...
                    if (!this.previousFilter) {
                        var e = x(t.target).closest(".ui-menu-item"), i = x(t.currentTarget);
        ...
        _create: function () {
            ...
            this.isMultiLine = e || !o && this._isContentEditable(this.element), this.valueMethod = this.element[e || o ? "val" : "text"], this.isNewMenu = !0, this._addClass("ui-autocomplete-input"), this.element.attr("autocomplete", "off"), this._on(this.element, {
                ...
                mousedown: function (t) {
                    ...
                    })) : (n = e.item.data("ui-autocomplete-item"), !1 !== this._trigger("focus", t, {item: n}) && t.originalEvent && /^key/.test(t.originalEvent.type) && this._value(n.value), void ((i = e.item.attr("aria-label") || n.value) && x.trim(i).length && (this.liveRegion.children().hide(), x("<div>").text(i).appendTo(this.liveRegion))))
    ...
    x.widget("ui.controlgroup", {
        ...
        _initWidgets: function () {
            ...
            x.each(this.options.items, function (s, t) {
                ...
                return t ? "controlgroupLabel" === s ? ((e = r.element.find(t)).each(function () {
                    ...
                    var t = x(this), e = t[s]("instance"), i = x.widget.extend({}, o);
        ...
        _enableDatepicker: function (e) {
            var t, i, n = x(e), s = x.data(e, "datepicker");
        ...
        _doKeyDown: function (t) {
            var e, i, n, s = x.datepicker._getInst(t.target), o = !0, r = s.dpDiv.is(".ui-datepicker-rtl");
        ...
        _checkExternalClick: function (t) {
            if (x.datepicker._curInst) {
                var e = x(t.target), i = x.datepicker._getInst(e[0]);
        ...
        _gotoToday: function (t) {
            var e, i = x(t), n = this._getInst(i[0]);
        ...
        _selectDate: function (t, e) {
            var i, n = x(t), s = this._getInst(n[0]);
        ...
        parseDate: function (i, o, t) {
            ...
            function e(t) {
                var e = r(t), i = "@" === t ? 14 : "!" === t ? 20 : "y" === t && e ? 4 : "o" === t ? 3 : 2,
                    n = RegExp("^\\d{" + ("y" === t ? i : 1) + "," + i + "}"), s = o.substring(u).match(n);
                if (!s) throw"Missing number at position " + u;
                return u += s[0].length, parseInt(s[0], 10)
            }

            function n(t, e, i) {
                var n = -1, s = x.map(r(t) ? i : e, function (t, e) {
                    return [[e, t]]
                }).sort(function (t, e) {
            ...
            var a, l, h, c, u = 0, d = (t ? t.shortYearCutoff : null) || this._defaults.shortYearCutoff,
                ...
                v = (t ? t.monthNames : null) || this._defaults.monthNames, _ = -1, b = -1, y = -1, w = -1, C = !1;
            for (a = 0; i.length > a; a++) if (C) "'" !== i.charAt(a) || r("'") ? s() : C = !1; else switch (i.charAt(a)) {
                case"d":
                    y = e("d");
                    break;
                case"D":
            ...
            if (-1 === _ ? _ = (new Date).getFullYear() : _ < 100 && (_ += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (_ <= p ? 0 : -100)), -1 < w) for (b = 1, y = w; !(y <= (l = this._getDaysInMonth(_, b - 1)));) b++, y -= l;
        ...
        formatDate: function (i, t, e) {
            ...
            var r, a = (e ? e.dayNamesShort : null) || this._defaults.dayNamesShort,
                ...
                c = (e ? e.monthNames : null) || this._defaults.monthNames, u = "", d = !1;
            if (t) for (r = 0; i.length > r; r++) if (d) "'" !== i.charAt(r) || s("'") ? u += i.charAt(r) : d = !1; else switch (i.charAt(r)) {
                case"d":
                    u += n("d", t.getDate(), 2);
                    break;
                case"D":
        ...
        _possibleChars: function (i) {
            ...
            var n, e = "", s = !1;
            for (n = 0; i.length > n; n++) if (s) "'" !== i.charAt(n) || t("'") ? e += i.charAt(n) : s = !1; else switch (i.charAt(n)) {
                case"d":
                case"m":
                case"y":
                case"@":
        ...
        _generateHTML: function (t) {
            var e, i, n, s, o, r, a, l, h, c, u, d, p, f, g, m, v, _, b, y, w, C, x, k, D, T, S, E, I, A, P, N, O, M, $,
                H, L, R, W, F = new Date,
                j = this._daylightSavingAdjust(new Date(F.getFullYear(), F.getMonth(), F.getDate())),
                z = this._get(t, "isRTL"), q = this._get(t, "showButtonPanel"), B = this._get(t, "hideIfNoPrevNext"),
                ...
                tt = t.drawYear;
            if (Z < 0 && (Z += 12, tt--), J) for (e = this._daylightSavingAdjust(new Date(J.getFullYear(), J.getMonth() - Y[0] * Y[1] + 1, J.getDate())), e = G && e < G ? G : e; this._daylightSavingAdjust(new Date(tt, Z, 1)) > e;) --Z < 0 && (Z = 11, tt--);
    ...
    x(document).on("mouseup", function () {
        ...
        start: function (t, e, i) {
            ...
            var n, s, o, r, a, l, h, c, u, d, p = i.options, f = p.snapTolerance, g = e.offset.left,
                m = g + i.helperProportions.width, v = e.offset.top, _ = v + i.helperProportions.height;
        ...
        start: function (t, e, i) {
            var n, s = i.options, o = x.makeArray(x(s.stack)).sort(function (t, e) {
        ...
        _setupHandles: function () {
            ...
            if (this.handles = o.handles || (x(".ui-resizable-handle", this.element).length ? {
                ...
                ne: ".ui-resizable-ne",
                nw: ".ui-resizable-nw"
            } : "e,s,se"), this._handles = x(), this.handles.constructor === String) for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), i = this.handles.split(","), this.handles = {}, e = 0; i.length > e; e++) n = "ui-resizable-" + (t = x.trim(i[e])), s = x("<div>"), this._addClass(s, "ui-resizable-handle " + n), s.css({zIndex: o.zIndex}), this.handles[t] = ".ui-resizable-" + t, this.element.append(s);
        ...
        start: function () {
            var i, n, t, e, s, o, r, a = x(this).resizable("instance"), l = a.options, h = a.element, c = l.containment,
            ...
            var e, i, n, s, o = x(this).resizable("instance"), r = o.options, a = o.containerOffset, l = o.position,
                h = o._aspectRatio || t.shiftKey, c = {top: 0, left: 0}, u = o.containerElement, d = !0;
            ...
            var t = x(this).resizable("instance"), e = t.options, i = t.containerOffset, n = t.containerPosition,
                s = t.containerElement, o = x(t.helper), r = o.offset(), a = o.outerWidth() - t.sizeDiff.width,
        ...
        resize: function () {
            var t, e = x(this).resizable("instance"), i = e.options, n = e.size, s = e.originalSize,
                ...
                l = a[0] || 1, h = a[1] || 1, c = Math.round((n.width - s.width) / l) * l,
                u = Math.round((n.height - s.height) / h) * h, d = s.width + c, p = s.height + u,
        ...
        _createButtons: function () {
            ...
            return this.uiDialogButtonPane.remove(), this.uiButtonSet.empty(), x.isEmptyObject(t) || x.isArray(t) && !t.length ? void this._removeClass(this.uiDialog, "ui-dialog-buttons") : (x.each(t, function (t, e) {
                ...
                e = x.isFunction(e) ? {
                    click: e,
                    text: t
                } : e, e = x.extend({type: "button"}, e), i = e.click, n = {
                    icon: e.icon,
        ...
        _drop: function (e, t) {
            ...
            return !(!i || (i.currentItem || i.element)[0] === this.element[0]) && (this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function () {
                ...
                return t.options.greedy && !t.options.disabled && t.options.scope === i.options.scope && t.accept.call(t.element[0], i.currentItem || i.element) && rt(i, x.extend(t, {offset: t.element.offset()}), t.options.tolerance, e) ? !(n = !0) : void 0
    ...
    var ot, rt = x.ui.intersect = function (t, e, i, n) {
        ...
        var s = (t.positionAbs || t.position.absolute).left + t.margins.left,
            ...
            a = o + t.helperProportions.height, l = e.offset.left, h = e.offset.top, c = l + e.proportions().width,
    ...
    !(x.ui.ddmanager = {
        ...
        _refreshValue: function () {
            ...
            this._hasMultipleValues() ? this.handles.each(function (t) {
                i = (a.values(t) - a._valueMin()) / (a._valueMax() - a._valueMin()) * 100, h["horizontal" === a.orientation ? "left" : "bottom"] = i + "%", x(this).stop(1, 1)[l ? "animate" : "css"](h, r.animate), !0 === a.options.range && ("horizontal" === a.orientation ? (0 === t && a.range.stop(1, 1)[l ? "animate" : "css"]({left: i + "%"}, r.animate), 1 === t && a.range[l ? "animate" : "css"]({width: i - e + "%"}, {
                    queue: !1,
                    duration: r.animate
        ...
        _intersectsWith: function (t) {
            var e = this.positionAbs.left, i = e + this.helperProportions.width, n = this.positionAbs.top,
                ...
                d = "y" === this.options.axis || o < e + c && e + c < r, p = u && d;
        ...
        _getItemsAsjQuery: function (t) {
            ...
            if (l && t) for (i = l.length - 1; 0 <= i; i--) for (n = (s = x(l[i], this.document[0])).length - 1; 0 <= n; n--) (o = x.data(s[n], this.widgetFullName)) && o !== this && !o.options.disabled && a.push([x.isFunction(o.options.items) ? o.options.items.call(o.element) : x(o.options.items, o.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), o]);
        ...
        _refreshItems: function (t) {
            ...
            var e, i, n, s, o, r, a, l, h = this.items,
                ...
                u = this._connectWith();
            if (u && this.ready) for (e = u.length - 1; 0 <= e; e--) for (i = (n = x(u[e], this.document[0])).length - 1; 0 <= i; i--) (s = x.data(n[i], this.widgetFullName)) && s !== this && !s.options.disabled && (c.push([x.isFunction(s.options.items) ? s.options.items.call(s.element[0], t, {item: this.currentItem}) : x(s.options.items, s.element), s]), this.containers.push(s));
            for (e = c.length - 1; 0 <= e; e--) for (o = c[e][1], i = 0, l = (r = c[e][0]).length; i < l; i++) (a = x(r[i])).data(this.widgetName + "-item", o), h.push({
                item: a,
                instance: o,
                width: 0,
                height: 0,
        ...
        _contactContainers: function (t) {
            ...
            for (e = this.containers.length - 1; 0 <= e; e--) if (!x.contains(this.currentItem[0], this.containers[e].element[0])) if (this._intersectsWith(this.containers[e].containerCache)) {
        ...
        load: function (t, n) {
            ...
            var o = this, i = this.tabs.eq(t), e = i.find(".ui-tabs-anchor"), r = this._getPanelForTab(i),
                a = {tab: i, panel: r};
        ...
        version: "1.12.1", options: {
            ...
            var e = t.data("ui-tooltip-id"), i = (t.attr("aria-describedby") || "").split(/\s+/), n = x.inArray(e, i);
            ...
            var s = this;
            x.each(this.tooltips, function (t, e) {
                var i = x.Event("blur"), n = e.element;
    ...
    var s, a = "alert", l = "bs.alert", h = "." + l, c = f.fn[a],
    ...
    var m, v = "button", _ = "bs.button", b = "." + _, y = ".data-api", w = f.fn[v], C = "active",
        x = '[data-toggle^="button"]', k = 'input:not([type="hidden"])', D = {
            ...
            if (i) {
                ...
                if (n) {
                    if ("radio" === n.type) if (n.checked && this._element.classList.contains(C)) t = !1; else {
    ...
    var E, I = "carousel", A = "bs.carousel", P = "." + A, N = f.fn[I],
        O = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, M = {
        ...
        }, R = "active", W = ".active.carousel-item", F = {TOUCH: "touch", PEN: "pen"},
        j = ((E = z.prototype).next = function () {
            ...
            if (!(t > this._items.length - 1 || t < 0)) if (this._isSliding) f(this._element).one(L.SLID, function () {
                return e.to(t)
            }); else {
            ...
            var i = t === $, n = t === H, s = this._getItemIndex(e), o = this._items.length - 1;
            if ((n && 0 === s || i && s === o) && !this._config.wrap) return e;
            var r = (s + (t === H ? -1 : 1)) % this._items.length;
            return -1 == r ? this._items[this._items.length - 1] : this._items[r]
        }, E._triggerSlideEvent = function (t, e) {
            var i = this._getItemIndex(t), n = this._getItemIndex(this._element.querySelector(W)),
            ...
            var i, n, s, o = this, r = this._element.querySelector(W), a = this._getItemIndex(r),
                l = e || r && this._getItemByDirection(t, r), h = this._getItemIndex(l), c = Boolean(this._interval);
            if (s = t === $ ? (i = "carousel-item-left", n = "carousel-item-next", "left") : (i = "carousel-item-right", n = "carousel-item-prev", "right"), l && f(l).hasClass(R)) this._isSliding = !1; else if (!this._triggerSlideEvent(l, s).isDefaultPrevented() && r && l) {
            ...
            return this.each(function () {
                var t = f(this).data(A), e = r({}, O, {}, f(this).data());
                "object" == typeof n && (e = r({}, e, {}, n));
                var i = "string" == typeof n ? n : e.slide;
                if (t || (t = new z(this, e), f(this).data(A, t)), "number" == typeof n) t.to(n); else if ("string" == typeof i) {
            ...
            if (e) {
                ...
                if (i && f(i).hasClass("carousel")) {
                    var n = r({}, f(i).data(), {}, f(this).data()), s = this.getAttribute("data-slide-to");
    ...
    var q, B = "collapse", U = "bs.collapse", Y = "." + U, K = f.fn[B], V = {toggle: !0, parent: ""},
        X = {toggle: "boolean", parent: "(string|element)"}, Q = {
            SHOW: "show" + Y,
            SHOWN: "shown" + Y,
            HIDE: "hide" + Y,
            HIDDEN: "hidden" + Y,
            CLICK_DATA_API: "click" + Y + ".data-api"
        }, G = "show", J = "collapse", Z = "collapsing", tt = "collapsed", et = '[data-toggle="collapse"]',
        it = ((q = nt.prototype).toggle = function () {
            ...
            if (!this._isTransitioning && f(this._element).hasClass(G)) {
                ...
                if (f(this._element).trigger(e), !e.isDefaultPrevented()) {
                    ...
                    if (0 < n) for (var s = 0; s < n; s++) {
                        var o = this._triggerArray[s], r = g.getSelectorFromElement(o);
            ...
            return this.each(function () {
                var t = f(this), e = t.data(U), i = r({}, V, {}, t.data(), {}, "object" == typeof n && n ? n : {});
    ...
    function nt(e, t) {
        ...
        for (var i = [].slice.call(document.querySelectorAll(et)), n = 0, s = i.length; n < s; n++) {
            var o = i[n], r = g.getSelectorFromElement(o),
    ...
    f(document).on(Q.CLICK_DATA_API, et, function (t) {
        ...
        f(n).each(function () {
            var t = f(this), e = t.data(U) ? "toggle" : i.data();
    ...
    var st = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator,
        ot = function () {
            for (var t = ["Edge", "Trident", "Firefox"], e = 0; e < t.length; e += 1) if (st && 0 <= navigator.userAgent.indexOf(t[e])) return 1;
            return 0
    ...
    function ct(t) {
        ...
        var e = lt(t), i = e.overflow, n = e.overflowX, s = e.overflowY;
    ...
    function wt(t) {
        var e = t.body, i = t.documentElement, n = ft(10) && getComputedStyle(i);
    ...
    function Dt(t) {
        return kt({}, t, {right: t.left + t.width, bottom: t.top + t.height})
    }
    ...
    function Tt(t) {
        ...
        try {
            if (ft(10)) {
                ...
                var i = _t(t, "top"), n = _t(t, "left");
                e.top += i, e.left += n, e.bottom += i, e.right += n
            } else e = t.getBoundingClientRect()
        } catch (t) {
        }
        var s = {left: e.left, top: e.top, width: e.right - e.left, height: e.bottom - e.top},
            o = "HTML" === t.nodeName ? wt(t.ownerDocument) : {}, r = o.width || t.clientWidth || s.width,
    ...
    function St(t, e, i) {
        var n = 2 < arguments.length && void 0 !== i && i, s = ft(10), o = "HTML" === e.nodeName, r = Tt(t), a = Tt(e),
            l = ct(t), h = lt(e), c = parseFloat(h.borderTopWidth, 10), u = parseFloat(h.borderLeftWidth, 10);
        ...
        return (s && !n ? e.contains(l) : e === l && "BODY" !== l.nodeName) && (d = function (t, e, i) {
            var n = 2 < arguments.length && !1, s = _t(e, "top"), o = _t(e, "left"), r = n ? -1 : 1;
    ...
    function It(t, e, i, n, s) {
        var o = 4 < arguments.length && void 0 !== s && s, r = {top: 0, left: 0}, a = o ? Et(t) : vt(t, ut(e));
        if ("viewport" === n) r = function (t, e) {
            var i = 1 < arguments.length && void 0 !== e && e, n = t.ownerDocument.documentElement, s = St(t, n),
                o = Math.max(n.clientWidth, window.innerWidth || 0),
                r = Math.max(n.clientHeight, window.innerHeight || 0), a = i ? 0 : _t(n), l = i ? 0 : _t(n, "left");
            ...
            if ("HTML" !== l.nodeName || function t(e) {
                ...
                var c = wt(t.ownerDocument), u = c.height, d = c.width;
    ...
    function At(t, e, n, i, s, o) {
        ...
        var a = It(n, i, r, s), l = {
            ...
            return kt({key: t}, l[t], {area: (e = l[t]).width * e.height});
            var e
        }).sort(function (t, e) {
    ...
    function Mt(t, e, i) {
        i = i.split("-")[0];
        var n = Nt(t), s = {width: n.width, height: n.height}, o = -1 !== ["right", "left"].indexOf(i),
    ...
    function zt(i, n) {
        Object.keys(n).forEach(function (t) {
            var e = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && jt(n[t]) && (e = "px"), i.style[t] = n[t] + e
        })
    }
    ...
    function Kt(t, e) {
        var i = 1 < arguments.length && void 0 !== e && e, n = Yt.indexOf(t),
            ...
            shift: {
                ...
                order: 500, enabled: !0, fn: function (t, e) {
                    ...
                    var s = t.placement.split("-")[0], o = t.offsets, r = o.popper, a = o.reference,
                        ...
                        u = c.toLowerCase(), d = l ? "left" : "top", p = l ? "bottom" : "right", f = Nt(n)[h];
                    a[p] - f < r[u] && (t.offsets.popper[u] -= r[u] - (a[p] - f)), a[u] + f > r[p] && (t.offsets.popper[u] += a[u] + f - r[p]), t.offsets.popper = Dt(t.offsets.popper);
                    var g = a[u] + a[h] / 2 - f / 2, m = lt(t.instance.popper), v = parseFloat(m["margin" + c], 10),
                        _ = parseFloat(m["border" + c + "Width"], 10), b = g - t.offsets.popper[u] - v - _;
                ...
                fn: function (g, m) {
                    ...
                    var v = It(g.instance.popper, g.instance.reference, m.padding, m.boundariesElement, g.positionFixed),
                        _ = g.placement.split("-")[0], b = Ot(_), y = g.placement.split("-")[1] || "", w = [];
                    switch (m.behavior) {
                        case"flip":
                            w = [_, b];
                            break;
                    ...
                    return w.forEach(function (t, e) {
                        ...
                        var i = g.offsets.popper, n = g.offsets.reference, s = Math.floor,
                ...
                order: 800, enabled: !0, fn: function (t) {
                    ...
                    var e = t.offsets.reference, i = $t(t.instance.modifiers, function (t) {
                ...
                order: 850, enabled: !0, fn: function (t, e) {
                    var i = e.x, n = e.y, s = t.offsets.popper, o = $t(t.instance.modifiers, function (t) {
                        return "applyStyle" === t.name
                    }).gpuAcceleration;
                    void 0 !== o && console.warn("WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!");
                    var r, a, l, h, c, u, d, p, f, g, m, v, _, b, y, w = void 0 !== o ? o : e.gpuAcceleration,
                        C = gt(t.instance.popper), x = Tt(C), k = {position: s.position},
                        D = (l = t, h = window.devicePixelRatio < 2 || !qt, c = l.offsets, u = c.popper, d = c.reference, p = Math.round, f = Math.floor, g = p(d.width), m = p(u.width), v = -1 !== ["left", "right"].indexOf(l.placement), _ = -1 !== l.placement.indexOf("-"), y = h ? p : I, {
                            ...
                            bottom: y(u.bottom),
                            right: b(u.right)
                        }), T = "bottom" === i ? "top" : "bottom", S = "right" === n ? "left" : "right",
                        E = Rt("transform");
                    ...
                    if (a = "bottom" == T ? "HTML" === C.nodeName ? -C.clientHeight + D.bottom : -x.height + D.bottom : D.top, r = "right" == S ? "HTML" === C.nodeName ? -C.clientWidth + D.right : -x.width + D.right : D.left, w && E) k[E] = "translate3d(" + r + "px, " + a + "px, 0)", k[T] = 0, k[S] = 0, k.willChange = "transform"; else {
                        var A = "bottom" == T ? -1 : 1, P = "right" == S ? -1 : 1;
    ...
    function Zt(t, e) {
        ...
        !function (t) {
            ...
            return kt({name: t}, i.options.modifiers[t])
        }).sort(function (t, e) {
    ...
    var te, ee = "dropdown", ie = "bs.dropdown", ne = "." + ie, se = ".data-api", oe = f.fn[ee],
        re = new RegExp("38|40|27"), ae = {
            HIDE: "hide" + ne,
            HIDDEN: "hidden" + ne,
            SHOW: "show" + ne,
            SHOWN: "shown" + ne,
        ...
        }, le = "disabled", he = "show", ce = "dropdown-menu-right", ue = '[data-toggle="dropdown"]', de = ".dropdown-menu",
        pe = {
            offset: 0,
            flip: !0,
            ...
            if (void 0 === t && (t = !1), !(this._element.disabled || f(this._element).hasClass(le) || f(this._menu).hasClass(he))) {
                var e = {relatedTarget: this._element}, i = f.Event(ae.SHOW, e),
            ...
            if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which)) for (var e = [].slice.call(document.querySelectorAll(ue)), i = 0, n = e.length; i < n; i++) {
                var s = me._getParentFromElement(e[i]), o = f(e[i]).data(ie), r = {relatedTarget: e[i]};
            ...
            if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || f(t.target).closest(de).length)) : re.test(t.which)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !f(this).hasClass(le))) {
                var e = me._getParentFromElement(this), i = f(e).hasClass(he);
                if (i || 27 !== t.which) if (i && (!i || 27 !== t.which && 32 !== t.which)) {
    ...
    var ve, _e = "modal", be = "bs.modal", ye = "." + be, we = f.fn[_e],
        Ce = {backdrop: !0, keyboard: !0, focus: !0, show: !0},
        xe = {backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean"}, ke = {
            HIDE: "hide" + ye,
        ...
        }, De = "modal-open", Te = "fade", Se = "show", Ee = "modal-static",
        Ie = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", Ae = ".sticky-top",
        Pe = ((ve = Ne.prototype).toggle = function (t) {
            ...
            var e = this, i = f(this._element).hasClass(Te),
            ...
            var e = this, i = f(this._element).hasClass(Te) ? Te : "";
            ...
            if (this._isBodyOverflowing) {
                var t = [].slice.call(document.querySelectorAll(Ie)), e = [].slice.call(document.querySelectorAll(Ae));
            ...
            return this.each(function () {
                var t = f(this).data(be), e = r({}, Ce, {}, f(this).data(), {}, "object" == typeof i && i ? i : {});
    ...
    function He(t, o, e) {
        ...
        for (var i = (new window.DOMParser).parseFromString(t, "text/html"), r = Object.keys(o), a = [].slice.call(i.body.querySelectorAll("*")), n = function (t) {
            ...
            var n = [].slice.call(e.attributes), s = [].concat(o["*"] || [], o[i] || []);
    ...
    var Le, Re = "tooltip", We = "bs.tooltip", Fe = "." + We, je = f.fn[Re], ze = "bs-tooltip",
        qe = new RegExp("(^|\\s)" + ze + "\\S+", "g"), Be = ["sanitize", "whiteList", "sanitizeFn"], Ue = {
            animation: "boolean",
            template: "string",
            ...
            whiteList: "object",
            popperConfig: "(null|object)"
        }, Ye = {AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left"}, Ke = {
            animation: !0,
        ...
        }, Qe = "fade", Ge = "show", Je = "hover", Ze = ((Le = ti.prototype).enable = function () {
            this._isEnabled = !0
        }, Le.disable = function () {
            this._isEnabled = !1
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                var s = this.getTipElement(), o = g.getUID(this.constructor.NAME);
            ...
            var t = f(this.getTipElement()), e = t.attr("class").match(qe);
            ...
            return this.each(function () {
                var t = f(this).data(We), e = "object" == typeof i && i;
    ...
    var ei = "popover", ii = "bs.popover", ni = "." + ii, si = f.fn[ei], oi = "bs-popover",
        ri = new RegExp("(^|\\s)" + oi + "\\S+", "g"), ai = r({}, Ze.Default, {
            placement: "right",
            trigger: "click",
            content: "",
            template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
        }), li = r({}, Ze.DefaultType, {content: "(string|element|function)"}), hi = {
            HIDE: "hide" + ni,
            HIDDEN: "hidden" + ni,
            SHOW: "show" + ni,
            SHOWN: "shown" + ni,
            ...
            return s.isWithContent = function () {
                ...
                var t = f(this.getTipElement()), e = t.attr("class").match(ri);
                null !== e && 0 < e.length && t.removeClass(e.join(""))
            }, n._jQueryInterface = function (i) {
                return this.each(function () {
                    var t = f(this).data(ii), e = "object" == typeof i ? i : null;
    ...
    var ui, di = "scrollspy", pi = "bs.scrollspy", fi = "." + pi, gi = f.fn[di],
        ...
        bi = "active", yi = ".nav, .list-group", wi = ".nav-link", Ci = ".list-group-item",
    ...
    var Di, Ti = "bs.tab", Si = "." + Ti, Ei = f.fn.tab, Ii = {
        HIDE: "hide" + Si,
        HIDDEN: "hidden" + Si,
        SHOW: "show" + Si,
        SHOWN: "shown" + Si,
        CLICK_DATA_API: "click.bs.tab.data-api"
    }, Ai = "active", Pi = "> li > .active", Ni = ((Di = Oi.prototype).show = function () {
        var i = this;
        if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && f(this._element).hasClass(Ai) || f(this._element).hasClass("disabled"))) {
            var t, n, e = f(this._element).closest(".nav, .list-group")[0], s = g.getSelectorFromElement(this._element);
            if (e) {
                var o = "UL" === e.nodeName || "OL" === e.nodeName ? Pi : ".active";
                n = (n = f.makeArray(f(e).find(o)))[n.length - 1]
            }
            var r = f.Event(Ii.HIDE, {relatedTarget: this._element}), a = f.Event(Ii.SHOW, {relatedTarget: n});
            if (n && f(n).trigger(r), f(this._element).trigger(a), !a.isDefaultPrevented() && !r.isDefaultPrevented()) {
                ...
                var l = function () {
                    var t = f.Event(Ii.HIDDEN, {relatedTarget: i._element}), e = f.Event(Ii.SHOWN, {relatedTarget: n});
    ...
    var Mi, $i = "toast", Hi = "bs.toast", Li = "." + Hi, Ri = f.fn[$i], Wi = {
            CLICK_DISMISS: "click.dismiss" + Li,
            HIDE: "hide" + Li,
            HIDDEN: "hidden" + Li,
            SHOW: "show" + Li,
            SHOWN: "shown" + Li
        }, Fi = "show", ji = {animation: "boolean", autohide: "boolean", delay: "number"},
        zi = {animation: !0, autohide: !0, delay: 500}, qi = ((Mi = Bi.prototype).show = function () {
            var t = this, e = f.Event(Wi.SHOW);
            if (f(this._element).trigger(e), !e.isDefaultPrevented()) {
    ...
    }, t.Alert = d, t.Button = T, t.Carousel = j, t.Collapse = it, t.Dropdown = ge, t.Modal = Pe, t.Popover = ci, t.Scrollspy = xi, t.Tab = Ni, t.Toast = qi, t.Tooltip = Ze, t.Util = g, Object.defineProperty(t, "__esModule", {value: !0})
}), function (C) {
    C.fn.extend({
        slimScroll: function (y) {
            ...
            return this.each(function () {
                ...
                var r, a, l, h, c, u, d, p, f = !1, g = C(this);
                if (g.parent().hasClass(w.wrapperClass)) {
                    var m = g.scrollTop(), v = g.siblings("." + w.barClass), _ = g.siblings("." + w.railClass);
                    if (i(), C.isPlainObject(y)) {
                        ...
                        if ("scrollTo" in y) m = parseInt(w.scrollTo); else if ("scrollBy" in y) m += parseInt(w.scrollBy); else if ("destroy" in y) return v.remove(), _.remove(), void g.unwrap();
                        n(m, !1, !0)
                    }
                    ...
                    }), i(), "bottom" === w.start ? (v.css({top: g.outerHeight() - v.outerHeight()}), n(0, !0)) : "top" !== w.start && (n(C(w.start).position().top, null, !0), w.alwaysVisible || v.hide()), window.addEventListener ? (this.addEventListener("DOMMouseScroll", e, !1), this.addEventListener("mousewheel", e, !1)) : document.attachEvent("onmousewheel", e)
                }
            }), this
        }
        ...
        function e(t, e) {
            if ("undefined" != typeof document) {
                for (var i = {}, n = document.cookie ? document.cookie.split("; ") : [], s = 0; s < n.length; s++) {
                    var o = n[s].split("="), r = o.slice(1).join("=");
...
var floatSubMenuTimeout, targetFloatMenu, handleSlimScroll = function () {
    ...
    if (!$(t).attr("data-init")) {
        var e = $(t).attr("data-height"), i = {height: e = e || $(t).height()};
    ...
    $(document).on("click", ".sidebar .nav > .has-sub > a", function () {
        var e = $(this).next(".sub-menu"), t = $(".sidebar .nav > li.has-sub > .sub-menu").not(e);
    ...
    $(document).on("click touchstart", ".sidebar", function (t) {
        ...
        t.stopPropagation();
        var e = "#page-container", i = "page-right-sidebar-collapsed";
        ...
        t.stopPropagation();
        var e = "page-sidebar-toggled", i = "#page-container";
    ...
    $(document).on("click", '[data-click="sidebar-minify"]', function (t) {
        t.preventDefault();
        var e = "page-sidebar-minified", i = "#page-container", n = !1;
    ...
    "use strict";
    var t = "", e = "", i = handleCheckBootstrapVersion();
    ...
    panelActionRunning = !0, $(document).on("hover", "[data-click=panel-remove]", function (t) {
        ...
        t.preventDefault();
        var e = $(this).closest(".panel"), i = $(e).find(".panel-body"), n = 40;
        if (0 !== $(i).length) {
            var s = $(e).offset().top;
            n = $(i).offset().top - s
        }
        if ($("body").hasClass("panel-expand") && $(e).hasClass("panel-expand")) $("body, .panel").removeClass("panel-expand"), $(".panel").removeAttr("style"), $(i).removeAttr("style"); else if ($("body").addClass("panel-expand"), $(this).closest(".panel").addClass("panel-expand"), 0 !== $(i).length && 40 != n) {
            var o = 40;
    ...
    $(t).sortable({
        handle: ".panel-heading", connectWith: ".row > [class*=col]", stop: function (t, e) {
    ...
    "use strict";
    var t = handleCheckBootstrapVersion(), e = "";
    ...
    if ($(document).on("click", '.theme-panel [data-click="theme-selector"]', function () {
        var t = $(this).attr("data-theme-file"), e = $(this).attr("data-theme");
        ...
        var t = $(this).is(":checked"), e = t ? "navbar-inverse" : "navbar-default",
        ...
        $(this).is(":checked") ? ($('.theme-panel [name="header-fixed"]').is(":checked") || (alert("Default Header with Fixed Sidebar option is not supported. Proceed with Fixed Header with Fixed Sidebar."), $('.theme-panel [name="header-fixed"]').prop("checked", !0), $("#page-container").addClass("page-header-fixed")), $("#page-container").addClass("page-sidebar-fixed"), $("#page-container").hasClass("page-sidebar-minified") || generateSlimScroll($('.sidebar [data-scrollbar="true"]')), t = !0) : ($("#page-container").removeClass("page-sidebar-fixed"), 0 !== $(".sidebar .slimScrollDiv").length && ($(window).width() <= 979 ? $(".sidebar").each(function () {
            if (!$("#page-container").hasClass("page-with-two-sidebar") || !$(this).hasClass("sidebar-right")) {
                ...
                var t = $(this).find('[data-scrollbar="true"]').parent(), e = $(t).html();
                $(t).replaceWith(e)
            }
        ...
        var t = Cookies.get("page-theme"), e = Cookies.get("header-theme"), i = Cookies.get("sidebar-grid"),
            n = Cookies.get("sidebar-gradient"), s = Cookies.get("sidebar-fixed"), o = Cookies.get("header-fixed");
    ...
    $(document).on("click", '[data-click="theme-panel-expand"]', function () {
        var t = ".theme-panel", e = "active", i = !1;
    ...
    0 < window.navigator.userAgent.indexOf("MSIE ") && $('.vertical-box-row [data-scrollbar="true"][data-height="100%"]').each(function () {
        var t = $(this).closest(".vertical-box-row"), e = $(t).height();
        $(t).find(".vertical-box-cell").height(e)
    })
}, handleUnlimitedTabsRender = function () {
    function e(t, e) {
        var i = $(t).closest(".tab-overflow"), n = "rtl" == $("body").css("direction") ? "margin-right" : "margin-left",
            s = parseInt($(i).find(".nav.nav-tabs").css(n)), o = $(i).width(), r = 0, a = 0;
        switch ($(i).find("li").each(function () {
            ...
            case"next":
                ...
                }, 150)) : a = o - s - 80, 0 !== a && ("rtl" != $("body").css("direction") ? $(i).find(".nav.nav-tabs").animate({marginLeft: "-" + a + "px"}, 150, function () {
                    $(i).addClass("overflow-left")
                }) : $(i).find(".nav.nav-tabs").animate({marginRight: "-" + a + "px"}, 150, function () {
                    $(i).addClass("overflow-left")
                }));
                break;
            case"prev":
                var l;
                a = (l = -s) <= o ? ($(i).removeClass("overflow-left"), 0) : l - o + 80, "rtl" != $("body").css("direction") ? $(i).find(".nav.nav-tabs").animate({marginLeft: "-" + a + "px"}, 150, function () {
        ...
        $(".tab-overflow").each(function () {
            !function (t, e) {
                ...
                var n = "rtl" == $("body").css("direction") ? "margin-right" : "margin-left",
                    s = (parseInt($(t).css(n)), $(t).width()), o = $(t).find(i).width(), r = -1 < e ? e : 150, a = 0;
    ...
    function e(t, e) {
        var i = $(t).closest(".nav"), n = "rtl" == $("body").css("direction") ? "margin-right" : "margin-left",
            s = parseInt($(i).css(n)), o = $(".top-menu").width() - 88, r = 0, a = 0;
        switch ($(i).find("li").each(function () {
            ...
            case"next":
                ...
                }, 150)) : a = o - s - 128, 0 !== a && ("rtl" != $("body").css("direction") ? $(i).animate({marginLeft: "-" + a + "px"}, 150, function () {
            ...
            case"prev":
                var l;
                a = (l = -s) <= o ? ($(i).find(".menu-control.menu-control-left").removeClass("show"), 0) : l - o + 88, "rtl" != $("body").css("direction") ? $(i).animate({marginLeft: "-" + a + "px"}, 150, function () {
    ...
    function t() {
        var t = $(".top-menu .nav"), e = $(".top-menu .nav > li"), i = $(".top-menu .nav > li.active"),
            n = $(".top-menu"), s = "rtl" == $("body").css("direction") ? "margin-right" : "margin-left",
            o = (parseInt($(t).css(s)), $(n).width() - 128), r = $(".top-menu .nav > li.active").width(), a = 0;
    ...
    $(document).on("click", ".top-menu .sub-menu .has-sub > a", function () {
        var t = $(this).closest("li").find(".sub-menu").first(), e = $(this).closest("ul").find(".sub-menu").not(t);
    ...
    $(document).on("click", '[data-toggle="nav-profile"]', function (t) {
        t.preventDefault();
        var e = $(this).closest("li"), i = $(".sidebar .nav.nav-profile");
    ...
    $(document).on("click", "#float-sub-menu li.has-sub > a", function (t) {
        var e = $(this).next(".sub-menu"), i = $(e).closest("li"), l = !1, h = !1;
        $(e).is(":visible") ? ($(i).addClass("closing"), l = !0) : ($(i).addClass("expanding"), h = !0), $(e).slideToggle({
            duration: 250,
            progress: function () {
                var t = $("#float-sub-menu"), e = $(t).height(), i = $(t).offset(), n = $(t).attr("data-offset-top"),
                    s = $(t).attr("data-menu-offset-top"), o = i.top - $(window).scrollTop(), r = $(window).height();
                if (l && n < o && (o = n < o ? n : o, $("#float-sub-menu").css({
                    ...
                    top: "20px",
                    bottom: "auto"
                }), $("#float-sub-menu-line").css({top: "20px", bottom: "auto"})), h && r - o < e) {
                    var a = r - s - 22;
                    $("#float-sub-menu").css({top: "auto", bottom: 0}), $("#float-sub-menu-arrow").css({
                        top: "auto",
                        bottom: a + "px"
                    }), $("#float-sub-menu-line").css({top: "20px", bottom: a + "px"})
                }
            },
            complete: function () {
        ...
        mouseenter: function () {
            if ($("#page-container").hasClass("page-sidebar-minified")) {
                ...
                var e = $(t).html();
                if (e) {
                    var i = $("#sidebar").offset(), n = parseInt($("#sidebar").width()),
                    ...
                    if (0 === $("#float-sub-menu").length ? (e = '<div class="float-sub-menu-container" id="float-sub-menu" data-offset-top="' + o + '" data-menu-offset-top="' + o + '" onmouseover="handleMouseoverFloatSubMenu(this)" onmouseout="handleMouseoutFloatSubMenu(this)">\t<div class="float-sub-menu-arrow" id="float-sub-menu-arrow"></div>\t<div class="float-sub-menu-line" id="float-sub-menu-line"></div>\t<ul class="float-sub-menu">' + e + "</ul></div>", $("#page-container").append(e)) : ($("#float-sub-menu").attr("data-offset-top", o), $("#float-sub-menu").attr("data-menu-offset-top", o), $(".float-sub-menu").html(e)), $("#float-sub-menu").height() < l - o) $("#float-sub-menu").css({
                        ...
                        $("#float-sub-menu-arrow").css({
                            top: "auto",
                            bottom: h + "px"
                        }), $("#float-sub-menu-line").css({top: "20px", bottom: h + "px"})
                    }
...
}, CLEAR_OPTION = "", handleAjaxMode = function (h) {
    ...
    function e(t, e, i) {
        ...
        var r = t.replace("#", ""), a = h.ajaxType ? h.ajaxType : "GET", l = h.ajaxDataType ? h.ajaxDataType : "html";
    ...
    $("[data-animation]").each(function () {
        var t = $(this).attr("data-animation"), e = $(this).attr("data-value");
        switch (t) {
            case"width":
                $(this).css("width", e);
                break;
