...
class UserAuthMobileAdmin(ModeloBaseAdmin):
    list_display = ('user', 'device', 'when', 'lastaccess', 'padre', 'authstr')

admin.site.register(UserAuthMobile, UserAuthMobileAdmin)
admin.site.register(AreaAutorizada, ModeloBaseAdmin)
