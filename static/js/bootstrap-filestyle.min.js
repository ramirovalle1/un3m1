(function(c){var b=function(d,e){
    ...
    b.prototype={clear:function(){
        ...
        if(d===true){
            ...
            if(d===false){
                if(this.options.icon){
                    ...
                    this.$elementFilestyle.find(".icon").remove()
                }
            }else{
        ...
        if(d!==undefined){
            this.$elementFilestyle.find(".icon").attr({"class":".icon "+this.options.iconName})
        }else{
            return this.options.iconName
        }
    },htmlIcon:function(){
        if(this.options.icon){
            return'<i class="'+this.options.iconName+'"></i> '
        }else{
            return""
        }
    },htmlInput:function(){
        ...
        if(this.$element[0].files===undefined){
            ...
            f=this.$element[0].files}for(var e=0;e<f.length;e++){
        ...
        i='<span class="group-span-filestyle '+(h.options.input?"input-group-btn":"")+'"><label for="'+g+'" class="btn '+h.options.buttonName+" "+(h.options.size=="nr"?"":"btn-"+h.options.size)+'" '+(h.options.disabled?'disabled="true"':"")+">"+h.htmlIcon()+h.options.buttonText+"</label></a>";
    ...
    c.fn.filestyle.defaults={buttonText:"Seleccionar",iconName:"fa fa-cloud-upload",buttonName:"btn-default",size:"nr",input:true,badge:true,icon:true,buttonBefore:false,disabled:false};
    ...
    c(function(){
        c(".filestyle").each(function(){
            var e=c(this),d={input:e.attr("data-input")==="false"?false:true,icon:e.attr("data-icon")==="false"?false:true,buttonBefore:e.attr("data-buttonBefore")==="true"?true:false,disabled:e.attr("data-disabled")==="true"?true:false,size:e.attr("data-size"),buttonText:e.attr("data-buttonText"),buttonName:e.attr("data-buttonName"),iconName:e.attr("data-iconName"),badge:e.attr("data-badge")==="false"?false:true};e.filestyle(d)
        })
    })
})(window.jQuery);