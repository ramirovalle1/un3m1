...
from sga.models import ProyectoGrado
    ...
    if request.method == 'POST':
        ...
        if 'action' in request.GET:
            ...
            if 's' in request.GET:
                ...
                ids = request.GET['id']
                proyectos = ProyectoGrado.objects.filter(id=ids)
            else:
                proyectos = ProyectoGrado.objects.all().order_by('-fechaaprobacion', 'preproyecto__titulo').distinct()
            ...
            return render(request, "adm_proyectosgrado/view.html", data)
