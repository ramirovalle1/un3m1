...
from sga.forms import CitaTutoriaForm, ActaAvanceTutoriaForm, CalificacionDocenteAnteproyectoForm
from sga.funciones import log, generar_nombre
from sga.models import ProyectoGrado, Tutoria, MESES_CHOICES, ActaAvance, AsistenciaActaAvance, Inscripcion, CalificacionPreproyecto
...
def view(request):
    ...
    if request.method == 'POST':
        ...
        if 'action' in request.GET:
            ...
            data['proyectos'] = ProyectoGrado.objects.filter(preproyecto__tutortitular=persona, estado=1).order_by('-fechaaprobacion', 'preproyecto__titulo').distinct()[:10]
            ...
            return render(request, "pro_tutorias/view.html", data)