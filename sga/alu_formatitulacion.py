...
from settings import PREPROYECTO_ESTADO_PENDIENTE_ID
from sga.commonviews import adduserdata
from sga.forms import AnteproyectoForm
from sga.funciones import variable_valor, log
from sga.models import Anteproyecto, Inscripcion, miinstitucion, CalificacionProyecto, Profesor, CUENTAS_CORREOS
...
def view(request):
    ...
    if request.method == 'POST':
        ...
        if action == 'add':
            try:
                ...
                if form.is_valid():
                    ...
                    log(u'Adiciono un anteproyecto en formacion titulacion: %s [%s] - titulo: %s' % (antepro,antepro.id, antepro.titulo), request, "add")
        ...
        if 'action' in request.GET:
            ...
            data['title'] = u'Gestion de Titulacion'
            ...
            return render(request, "alu_formatitulacion/view.html", data)
