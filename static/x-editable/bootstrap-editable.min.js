...
!function (a) {
    ...
    b.prototype = {
        constructor: b, init: function () {
            ...
            var a, b, c = this.initItems("M"), d = -1 !== this.options.template.indexOf("MMMM"),
            ...
            var a, b, c = this.initItems("h"), d = -1 !== this.options.template.indexOf("h"),
    ...
    a.extend(a.fn.editableform.Constructor.prototype, {
        initTemplate: function () {
            ...
            b.apply(this);
            var c = null === this.input.options.inputclass || this.input.options.inputclass === !1, d = "input-medium",
    ...
    }), a.fn.editableform.buttons = '<button type="submit" class="btn btn-primary editable-submit"><i class="fa fa-check"></i></button><button type="button" class="btn editable-cancel"><i class="fa fa-times"></i></button>', a.fn.editableform.errorGroupClass = "error", a.fn.editableform.errorBlockClass = null, a.fn.editableform.engine = "bs2"
}(window.jQuery), function (a) {
    "use strict";
    a.extend(a.fn.editableContainer.Popup.prototype, {
        ...
        setPosition: function () {
            !function () {
                ...
                }, h = {top: c.top - e, left: c.left + c.width / 2 - d / 2}, j = {
                    top: c.top + c.height / 2 - e / 2,
                    left: c.left - d
                }, k = {top: c.top + c.height / 2 - e / 2, left: c.left + c.width}, f) {
                    case"bottom":
    ...
    var k = a.fn.datepicker.dates = {
        ...
        headTemplate: '<thead><tr><th class="prev"><i class="fa fa-chevron-left"/></th><th colspan="5" class="datepicker-switch"></th><th class="next"><i class="fa fa-chevron-right"/></th></tr></thead>',
