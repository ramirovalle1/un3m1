...
codigosmateriainvestigacion = [216,
223,
906,
3204,
3770,
...
silaboxduplicar = Silabo.objects.filter(materia_id=71204)[0]
listadoprofesormateria1 = ProfesorMateria.objects.filter(materia__nivel__periodo_id=224, tipoprofesor_id=16,materia__modeloevaluativo_id=27, status=True, materia__asignaturamalla__asignatura_id__in=codigosmateriainvestigacion).exclude(materia_id__in=[71204])
...
#         print(cuenta)
c = 1
listadoprofesormateria = ProfesorMateria.objects.filter(materia__nivel__periodo_id=224, tipoprofesor_id=16,materia__modeloevaluativo_id=27,status=True, materia__asignaturamalla__asignatura_id__in=codigosmateriainvestigacion).exclude(materia_id__in=[71204])
