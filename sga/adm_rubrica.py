            ...
            try:
                if 'id' in request.POST and 'st' in request.POST and 'obs' in request.POST:
                    ...
                    if 2 == int(request.POST['st']):
                        rubrica.estado = True
                        rubrica.save(request)
                        log(u'Aprobó la rubrica del profesor %s' % (rubrica), request, "add")
                        # silabo.materia.crear_actualizar_silabo_curso()
                    else:
                        log(u'Rechazó la rubrica del profesor %s' % (rubrica), request, "add")
        ...
        if 'action' in request.GET:
            ...
            if action == 'add':
                try:
                    ...
                    form.add(periodo)
                    data['form'] = form
                    return render(request, "adm_rubrica/add.html", data)
                except Exception as ex:
                    pass
            ...
            if action == 'additem':
                try:
                    ...
                    data['form'] = form
                    return render(request, "adm_rubrica/additem.html", data)
                except Exception as ex:
                    pass
            ...
            if action == 'adddetalle':
                try:
                    ...
                    data['form'] = form
                    return render(request, "adm_rubrica/adddetalle.html", data)
                except Exception as ex:
                    pass
                ...
                try:
                    ...
                    data['form'] = form
                    data['rubrica'] = r
                    return render(request, "adm_rubrica/edit.html", data)
                except Exception as ex:
                    pass
                ...
                try:
                    ...
                    data['criterio'] = r
                    data['form'] = form
                    return render(request, "adm_rubrica/edititem.html", data)
                except Exception as ex:
                    pass
                ...
                try:
                    ...
                    data['detalle'] = r
                    data['form'] = form
                    return render(request, "adm_rubrica/editdetalle.html", data)
                except Exception as ex:
                    pass
                ...
                try:
                    ...
                    return render(request, "adm_rubrica/del.html", data)
                except Exception as ex:
                    pass
                ...
                try:
                    ...
                    return render(request, "adm_rubrica/delitem.html", data)
                except Exception as ex:
                    pass
                ...
                try:
                    ...
                    return render(request, "adm_rubrica/deldetalle.html", data)
                except Exception as ex:
                    pass
                ...
                try:
                    ...
                    data['items'] = items
                    return render(request, "adm_rubrica/items.html", data)
                except Exception as ex:
                ...
                try:
                    ...
                    return render(request, "adm_rubrica/detalle.html", data)
                except Exception as ex:
                    return JsonResponse({"result": "bad", "mensaje": u"Error. %s"%ex})
                    pass

            elif action == 'aprobar_rubricas':
                try:
                    search = None
                    ids = None
                    if 'id' in request.GET:
                        ...
                        search = request.GET['s']
                        rubricas = RubricaMoodle.objects.filter(nombre__icontains=search, status=True, estado=False, profesor__isnull=False).order_by('-id')
                    else:
                        rubricas = RubricaMoodle.objects.filter(status=True, estado=False, profesor__isnull=False).order_by('-id')
                    ...
                    return render(request, "adm_rubrica/aprobar_rubricas.html", data)
                except Exception as ex:
                    pass
            ...
            try:
                ...
                if 'id' in request.GET:
                    ...
                    search = request.GET['s']
                    rubricas = RubricaMoodle.objects.filter(nombre__icontains=search, status=True).order_by('-id')
                else:
                    rubricas = RubricaMoodle.objects.filter(status=True).order_by('-id')
                paging = MiPaginador(rubricas, 25)
                p = 1
                try:
                    paginasesion = 1
                ...
                data['ids'] = ids if ids else ""
                data['rubricas'] = page.object_list
                return render(request, "adm_rubrica/view.html", data)
            except Exception as ex:
                pass