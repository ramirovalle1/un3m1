...
from sga.models import Persona, Carrera, CUENTAS_CORREOS, CompendioSilaboSemanal, VideoMagistralSilaboSemanal, \
    ...
    DetalleSilaboSemanalTema, TipoDescuentoMatricula, DetalleConfiguracionDescuentoPosgrado
from posgrado.models import PreInscripcion, FormatoCarreraIpec, EvidenciasMaestrias, CohorteMaestria, CONTACTO_MAESTRIA
    ...
    if request.method == 'POST':
        ...
        if 'action' in request.GET:
            ...
            try:
                ...
                return render(request, "postu_requisitos/postulacion.html", data)
            except Exception as ex:
                pass
