...
try:
    ...
    for materia in Materia.objects.filter(status=True, nivel__periodo=periodo, esintroductoria=False, asignaturamalla__malla__carrera__in=[97,98,99,100,101,104,105,96,102,103], asignaturamalla__malla__inicio__year=2018):
