...
var FullCalendar = function (e) {
    ...
    function wr(e, t) {
        ...
        var n = window.getComputedStyle(e), r = parseInt(n.borderLeftWidth, 10) || 0,
            ...
            a = parseInt(n.borderBottomWidth, 10) || 0, s = Cr(e), l = s.y - r - o, u = {
                borderLeft: r,
                borderRight: o,
                borderTop: i,
                borderBottom: a,
    ...
    function Rr(e, t, n) {
        void 0 === t && (t = !1);
        var r = n ? e.getBoundingClientRect() : Tr(e), o = wr(e, t), i = {
    ...
    var Or = FullCalendarVDom.Component, Ar = FullCalendarVDom.createElement, Ur = FullCalendarVDom.render,
        Lr = FullCalendarVDom.createRef, Wr = FullCalendarVDom.Fragment, Vr = FullCalendarVDom.createContext,
        Fr = FullCalendarVDom.flushToDom, zr = FullCalendarVDom.unmountComponentAtNode, Br = function () {
            function e(e, t, n) {
                var o = this;
    ...
    var go = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            var e = this.context.pluginHooks.contentTypeHandlers, t = this.props, n = this.customContentInfo,
                o = So(t.content, t.hookProps), i = null;
    ...
    var Jo = function () {
        function e(e) {
            ...
            var s, l, u,
                c = (s = o.calendarOptions, l = o.dateEnv, null != (u = s.initialDate) ? l.createMarker(u) : Fn(s.now, l)),
        ...
        return e.prototype.resetOptions = function (e, t) {
            ...
            var n = _t([wt, e, t]), o = n.locales, i = n.locale, a = this.organizeRawLocales(o), s = a.map,
                l = this.buildLocale(i || a.defaultCode, s).options, u = this.buildPluginHooks(e.plugins || [], Go),
    ...
    var yi = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Ar(jr.Provider, {value: l}, n.headerToolbar && Ar(Ei, r({
                ref: this.headerRef,
    ...
    var _i = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.context, t = e.dateEnv, n = e.options, o = e.theme, i = e.viewApi, a = this.props, s = a.date,
                l = a.dateProfile, u = gr(s, a.todayRange, null, l), c = [Mi].concat(mr(u, o)),
            ...
            return Ar(fo, {
                ...
                return Ar("th", r({
                    ...
                    colSpan: a.colSpan
                }, a.extraDataAttrs), Ar("div", {className: "fc-scrollgrid-sync-inner"}, !u.isDisabled && Ar("a", r({
                    ref: n,
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.dateEnv, o = t.theme, i = t.viewApi, a = t.options,
                ...
                u = [Mi].concat(mr(l, o), e.extraClassNames || []), c = n.format(s, e.dayHeaderFormat),
            ...
            return Ar(fo, {
                ...
                return Ar("th", r({
                    ...
                    colSpan: e.colSpan
                }, e.extraDataAttrs), Ar("div", {className: "fc-scrollgrid-sync-inner"}, Ar("a", {
    ...
    function Zi(e, t) {
        for (var n = [], r = 0, i = e; r < i.length; r++) for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1) n.push(Ar("col", {
            style: {
    ...
    var na = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return "outerContent" in e ? Ar(Wr, {key: e.key}, e.outerContent) : Ar("tr", {
                key: e.key,
            ...
            var r = this.props, o = this.state, i = o.forceYScrollbars, a = o.scrollerClientWidths,
                s = o.scrollerClientHeights, l = Gi(r, e), u = ji(r, e),
                c = r.liquid ? i ? "scroll" : l ? "auto" : "hidden" : "visible", d = e.key, p = qi(e, n, {
                    tableColGroupNode: t,
                    tableMinWidth: "",
            ...
            return Ar("td", {ref: n.elRef}, Ar("div", {className: "fc-scroller-harness" + (u ? " fc-scroller-harness-liquid" : "")}, Ar(Fi, {
    ...
    var ra = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Ar(ra, {
                ...
                }, a), s.isStartResizable && Ar("div", {className: "fc-event-resizer fc-event-resizer-start"}), s.isEndResizable && Ar("div", {className: "fc-event-resizer fc-event-resizer-end"}))
            }))
        }, t
    }(Yr);
    ...
    var aa = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.options, r = ua({
                date: e.date,
                dateProfile: e.dateProfile,
    ...
    function ua(e) {
        ...
        return r(r(r({
            date: n.toDate(t),
            view: e.viewApi
        }, o), {dayNumberText: e.showDayNumber ? n.format(t, sa) : ""}), e.extraProps)
    }
            ...
            return o.isRendering = !1, o.isRendered = !1, o.currentClassNames = [], o.customContentRenderId = 0, o.handleAction = function (e) {
                ...
                if (o.isRendering) {
                    ...
                    Ur(Ar(Ti, {options: e.calendarOptions, theme: e.theme, emitter: e.emitter}, (function (t, n, i, a) {
                        return o.setClassNames(t), o.setHeight(n), Ar(ho.Provider, {value: o.customContentRenderId}, Ar(Ci, r({
                            isHeightAuto: i,
                            forPrint: a
                        }, e)))
                    })), o.el)
        ...
        function t(t) {
            ...
            n.handlePointerDown = function (e) {
                ...
                if (!n.dragging.pointer.wasTouchScroll) {
                    ...
                    if (i && a && Ia(i, a)) {
                        var s = t.context, l = r(r({}, Pa(i.dateSpan, s)), {
                            dayEl: i.dayEl,
                            jsEvent: e.origEvent,
            ...
            o.subjectEl = null, o.subjectSeg = null, o.isDragging = !1, o.eventRange = null, o.relevantEvents = null, o.receivingContext = null, o.validMutation = null, o.mutatedRelevantEvents = null, o.handlePointerDown = function (e) {
                ...
                if (o.isDragging) {
                    var t = o.component.context, n = t.viewApi, i = o, a = i.receivingContext, s = i.validMutation,
                        l = o.eventRange.def, u = o.eventRange.instance, c = new Bn(t, l, u), d = o.relevantEvents,
        ...
        function t(t) {
            ...
            n.draggingSegEl = null, n.draggingSeg = null, n.eventRange = null, n.relevantEvents = null, n.validMutation = null, n.mutatedRelevantEvents = null, n.handlePointerDown = function (e) {
                ...
                e && (u = function (e, t, n, o, i) {
                    ...
                    state: p
                }) : i.dispatch({type: "UNSET_EVENT_RESIZE"}), d ? te() : ne(), t || (u && Ia(s, e) && (u = null), n.validMutation = u, n.mutatedRelevantEvents = c)
            }, n.handleDragEnd = function (e) {
                var t = n.component.context, o = n.eventRange.def, i = n.eventRange.instance, a = new Bn(t, o, i),
    ...
    var Fa = function () {
        ...
        return n(t, e), t.prototype.renderSimpleLayout = function (e, t) {
            ...
            return e && o.push({
                ...
                }, Ar(na, {liquid: !n.isHeightAuto && !n.forPrint, cols: [], sections: o}))
            }))
            ...
            var i = this.props, a = this.context, s = !i.forPrint && ea(a.options), l = !i.forPrint && ta(a.options),
                u = [];
            return e && u.push({
                type: "header",
                key: "header",
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Ar(ca, {
                ...
                return Ar("td", r({
                    ...
                    ref: i.innerElRef
                }, i.showWeekNumber && Ar(ha, {date: a, defaultFormat: Ja}, (function (e, t, n, o) {
    ...
    var ns = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.options.eventTimeFormat || es,
    ...
    function rs(e) {
        ...
        }), e.timeText && Ar("div", {className: "fc-event-time"}, e.timeText), Ar("div", {className: "fc-event-title"}, e.event.title || Ar(Wr, null, " ")))
    }
    ...
    var ls = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = this.props, n = this.state, o = this.context, i = t.cells.length,
                a = Ya(t.businessHourSegs, i), s = Ya(t.bgEventSegs, i), l = Ya(this.getHighlightSegs(), i),
    ...
    var us = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Ar("div", r({className: n.join(" ")}, t.extraAttrs, {ref: this.handleRootEl}), Ar("div", {className: "fc-popover-header " + e.getClass("popoverHeader")}, Ar("span", {className: "fc-popover-title"}, t.title), Ar("span", {
    ...
    var hs = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = this.context, n = t.options, r = t.dateProfileGenerator, o = this.props,
                i = this.buildDayTableModel(o.dateProfile, r), a = n.dayHeaders && Ar(Hi, {
                    ref: this.headerRef,
    ...
    function Ds(e) {
        ...
        return Ar(jr.Consumer, null, (function (n) {
            ...
            return Ar(fo, {
                ...
                }, Ar("div", {className: "fc-timegrid-slot-label-frame fc-scrollgrid-shrink-frame"}, Ar("div", {
    ...
    var Cs = function (e) {
        ...
        function t() {
            ...
            return t.allDaySplitter = new Es, t.headerElRef = Lr(), t.rootElRef = Lr(), t.scrollerElRef = Lr(), t.state = {slatCoords: null}, t.handleScrollTopRequest = function (e) {
                ...
                })) : Ar("th", {className: "fc-timegrid-axis"}, Ar("div", {
        ...
        return n(t, e), t.prototype.renderSimpleLayout = function (e, t, n) {
            ...
            return e && i.push({
                ...
                type: "body",
                key: "all-day-divider",
                outerContent: Ar("tr", {className: "fc-scrollgrid-section"}, Ar("td", {className: "fc-timegrid-divider " + r.theme.getClass("tableCellShaded")}))
            })), i.push({
                type: "body",
                key: "body",
                liquid: !0,
                ...
                return Ar("div", {
                    ...
                    ref: e
                }, Ar(na, {liquid: !o.isHeightAuto && !o.forPrint, cols: [{width: "shrink"}], sections: i}))
            }))
            ...
            var u = this.context, c = this.props, d = !c.forPrint && ea(u.options), p = !c.forPrint && ta(u.options),
                f = [];
            e && f.push({
                type: "header",
                key: "header",
                ...
                key: "all-day-divider",
                type: "body",
                outerContent: Ar("tr", {className: "fc-scrollgrid-section"}, Ar("td", {
                    colSpan: 2,
            ...
            return f.push({
                ...
                type: "footer",
                isSticky: !0,
                chunks: [{key: "axis", content: Qi}, {key: "cols", content: Qi}]
    ...
    var ks = function () {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Ar("tbody", null, e.slatMetas.map((function (i, a) {
                ...
                return Ar("tr", {key: i.key, ref: o.createRef(i.key)}, e.axis && Ar(Ds, r({}, i)), Ar(fo, {
                    hookProps: s,
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            }, e.tableColGroupNode, Ar(Ms, {slatElRefs: this.slatElRefs, axis: e.axis, slatMetas: e.slatMetas})))
        }, t.prototype.componentDidMount = function () {
            this.updateSizing()
        }, t.prototype.componentDidUpdate = function () {
            this.updateSizing()
    ...
    var Fs = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Ar(ca, {
                ...
                }, l, t.extraDataAttrs), Ar("div", {className: "fc-timegrid-col-frame"}, Ar("div", {className: "fc-timegrid-col-bg"}, e.renderFillSegs(t.businessHourSegs, "non-business"), e.renderFillSegs(t.bgEventSegs, "bg-event"), e.renderFillSegs(t.dateSelectionSegs, "highlight")), Ar("div", {className: "fc-timegrid-col-events"}, e.renderFgSegs(t.fgEventSegs, i)), Ar("div", {className: "fc-timegrid-col-events"}, e.renderFgSegs(o, {}, Boolean(t.eventDrag), Boolean(t.eventResize), Boolean(n))), Ar("div", {className: "fc-timegrid-now-indicator-container"}, e.renderNowIndicator(t.nowIndicatorSegs)), Ar(Vs, {
                    date: t.date,
                    dateProfile: t.dateProfile,
                    todayRange: t.todayRange,
                    extraHookProps: t.extraHookProps
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            }, t.tableColGroupNode, Ar("tbody", null, Ar("tr", null, t.axis && Ar("td", {className: "fc-timegrid-col fc-timegrid-axis"}, Ar("div", {className: "fc-timegrid-col-frame"}, Ar("div", {className: "fc-timegrid-now-indicator-container"}, "number" == typeof n && Ar(aa, {
                isAxis: !0,
                date: t.nowDate
            }, (function (e, t, r, o) {
                return Ar("div", {
    ...
    var Ks = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = this.context, n = t.options, o = t.dateEnv, i = t.dateProfileGenerator, a = this.props,
                ...
                d = n.dayMinWidth, p = !d, f = d, h = n.dayHeaders && Ar(Hi, {
                    dates: l.headerDates,
                    dateProfile: s,
    ...
    var $s = lo({
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = e.dayDate, n = e.todayRange, o = this.context, i = o.theme, a = o.dateEnv,
                s = o.options, l = o.viewApi, u = gr(t, n), c = s.listDayFormat ? a.format(t, s.listDayFormat) : "",
                d = s.listDaySideFormat ? a.format(t, s.listDaySideFormat) : "", p = s.navLinks ? yr(t) : null,
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Ar(ra, {
                ...
                return Ar("tr", {
                    ...
                    return null
                }(n, r, t), Ar("td", {className: "fc-list-event-graphic"}, Ar("span", {
    ...
    var il = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Ar(Do, {viewSpec: n.viewSpec, elRef: this.setRootEl}, (function (n, o) {
                return Ar("div", {ref: n, className: r.concat(o).join(" ")}, Ar(Fi, {
